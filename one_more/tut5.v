...
/*Produced by NSL Core(version=20250428), IP ARCH, Inc. Thu May 21 18:54:32 2026
...
#1 if (start===1'bx)
 begin
$display("Warning: control hazard(tut5:start) at %d",$time);
 end
...
#1 if (_reg_4_goto===1'bx)
 begin
$display("Warning: control hazard(tut5:_reg_4_goto) at %d",$time);
 end
#1 if ((((_reg_4&_net_8))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_4&_net_8) || 1'b1) line 15 at %d\n",$time);
 end
...
#1 if (_reg_4_goin===1'bx)
 begin
$display("Warning: control hazard(tut5:_reg_4_goin) at %d",$time);
 end
#1 if ((((_reg_4&_net_8))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_4&_net_8) || 1'b1) line 15 at %d\n",$time);
 end
...
if ((((start|_reg_5)|(_reg_4&_net_8))==1'b1) ||
 ...
 begin $display("Warning: assign collision(tut5:loop) at %d",$time);

  end
 end
 else 
 $display("Warning: register set hazard(tut5:loop) at %d",$time);
