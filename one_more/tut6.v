...
/*Produced by NSL Core(version=20250428), IP ARCH, Inc. Thu May 28 19:31:21 2026
...
module tut6 ( p_reset , m_clock );
  ...
  wire _reg_5_goin;
   ...
   assign  value = (_net_3)? ((_net_3)?8'b00001001:8'b0):8'bx;
...
#1 if (_reg_5_goto===1'bx)
 begin
$display("Warning: control hazard(tut6:_reg_5_goto) at %d",$time);
 end
#1 if (((((_reg_5&(~_net_9))&_net_10))===1'bx) || (1'b1)===1'bx) $display("hazard (((_reg_5&(~_net_9))&_net_10) || 1'b1) line 15 at %d\n",$time);
#1 if ((((_reg_5&_net_9))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_5&_net_9) || 1'b1) line 15 at %d\n",$time);
 end
...
#1 if (_reg_4_goin===1'bx)
 begin
$display("Warning: control hazard(tut6:_reg_4_goin) at %d",$time);
 end
#1 if ((((_reg_5&_net_9))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_5&_net_9) || 1'b1) line 15 at %d\n",$time);
 end
...
#1 if (_reg_5_goin===1'bx)
 begin
$display("Warning: control hazard(tut6:_reg_5_goin) at %d",$time);
 end
#1 if (((((_reg_5&(~_net_9))&_net_10))===1'bx) || (1'b1)===1'bx) $display("hazard (((_reg_5&(~_net_9))&_net_10) || 1'b1) line 15 at %d\n",$time);
 end
...
if ((((start|_reg_6)|(_reg_5&(~_net_9)))==1'b1) ||
 ...
 begin $display("Warning: assign collision(tut6:loop) at %d",$time);

  end
 end
 else 
 $display("Warning: register set hazard(tut6:loop) at %d",$time);
