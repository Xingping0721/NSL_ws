...
/*Produced by NSL Core(version=20250428), IP ARCH, Inc. Thu May 14 10:54:58 2026
...
#1 if (start===1'bx)
 begin
$display("Warning: control hazard(tut3:start) at %d",$time);
 end
#1 if (((_net_0)===1'bx) || (1'b1)===1'bx) $display("hazard (_net_0 || 1'b1) line 5 at %d\n",$time);
 end
   assign  start = _net_0;
