...
/*Produced by NSL Core(version=20250428), IP ARCH, Inc. Thu May 28 20:49:59 2026
...
#1 if (_sm_ex===1'bx)
 begin
$display("Warning: control hazard(tut7:_sm_ex) at %d",$time);
 end
#1 if (((_net_1)===1'bx) || (1'b1)===1'bx) $display("hazard (_net_1 || 1'b1) line 24 at %d\n",$time);
 end
...
#1 if (_sm_1_ex===1'bx)
 begin
$display("Warning: control hazard(tut7:_sm_1_ex) at %d",$time);
 end
#1 if (((_net_1)===1'bx) || (1'b1)===1'bx) $display("hazard (_net_1 || 1'b1) line 25 at %d\n",$time);
 end
