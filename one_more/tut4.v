...
/*Produced by NSL Core(version=20250428), IP ARCH, Inc. Thu May 21 18:34:06 2026
...
#1 if (start===1'bx)
 begin
$display("Warning: control hazard(tut4:start) at %d",$time);
 end
...
#1 if (_reg_4_goto===1'bx)
 begin
$display("Warning: control hazard(tut4:_reg_4_goto) at %d",$time);
 end
#1 if (((((_reg_4&(~_net_8))&_net_9))===1'bx) || (1'b1)===1'bx) $display("hazard (((_reg_4&(~_net_8))&_net_9) || 1'b1) line 17 at %d\n",$time);
#1 if ((((_reg_4&_net_8))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_4&_net_8) || 1'b1) line 17 at %d\n",$time);
 end
...
#1 if (_reg_3_goin===1'bx)
 begin
$display("Warning: control hazard(tut4:_reg_3_goin) at %d",$time);
 end
#1 if ((((_reg_4&_net_8))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_4&_net_8) || 1'b1) line 17 at %d\n",$time);
 end
...
#1 if (_reg_4_goin===1'bx)
 begin
$display("Warning: control hazard(tut4:_reg_4_goin) at %d",$time);
 end
#1 if (((((_reg_4&(~_net_8))&_net_9))===1'bx) || (1'b1)===1'bx) $display("hazard (((_reg_4&(~_net_8))&_net_9) || 1'b1) line 17 at %d\n",$time);
 end
