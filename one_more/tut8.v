...
#1 if (go===1'bx)
 begin
$display("Warning: control hazard(tut8:go) at %d",$time);
 end
#1 if (((_net_18)===1'bx) || (1'b1)===1'bx) $display("hazard (_net_18 || 1'b1) line 51 at %d\n",$time);
 end
   assign  go = _net_18;
...
#1 if (_divid_divu_do===1'bx)
 begin
$display("Warning: control hazard(tut8:_divid_divu_do) at %d",$time);
 end
#1 if (((_reg_23)===1'bx) || (1'b1)===1'bx) $display("hazard (_reg_23 || 1'b1) line 62 at %d\n",$time);
 end
...
#1 if (_reg_22_goto===1'bx)
 begin
$display("Warning: control hazard(tut8:_reg_22_goto) at %d",$time);
 end
#1 if ((((_reg_22&_net_26))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_22&_net_26) || 1'b1) line 66 at %d\n",$time);
 end
...
#1 if (_reg_22_goin===1'bx)
 begin
$display("Warning: control hazard(tut8:_reg_22_goin) at %d",$time);
 end
#1 if ((((_reg_22&_net_26))===1'bx) || (1'b1)===1'bx) $display("hazard ((_reg_22&_net_26) || 1'b1) line 66 at %d\n",$time);
 end
